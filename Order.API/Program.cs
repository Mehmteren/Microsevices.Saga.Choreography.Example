    ...
    IPublishEndpoint publishEndpoint) =>
{
    ...
    {
        BuyerId = Guid.TryParse(model.BuyerId, out Guid _buyerId) ? _buyerId:
        Guid.NewGuid(),
    ...
    OrderCreatedEvent orderCreatedEvent = new()
    {
        ...
        OrderItems = order.OrderItems.Select(oi=>new Shared.Messages.OrderItemMessages()
        {
            Count = oi.Count,
            Price = oi.Price,
    ...
    await publishEndpoint.Publish(orderCreatedEvent);  //ilgili eventi yayýnlayalým
